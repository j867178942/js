...
localStorage.setItem('杀手组',JSON.stringify(killer_arr))
localStorage.setItem('平民组',JSON.stringify(civilian_arr))

localStorage.setItem('随机组',JSON.stringify(random_arr))
localStorage.setItem('被杀组',JSON.stringify(be_killed))
localStorage.setItem('被投组',JSON.stringify(be_vote))
localStorage.setItem('对象组',JSON.stringify(condition))
